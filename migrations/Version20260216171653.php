 ...
 */
final class Version20260216171653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP created_at, CHANGE phone phone VARCHAR(15) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD created_at DATETIME NOT NULL, CHANGE phone phone VARCHAR(20) NOT NULL');
    }
}
